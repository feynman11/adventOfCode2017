...
public class day5 {
	...
	public void go() {
		...
		for (int i = 0; i < offsetString.length; i++) {
			offsets[i] = Integer.parseInt(offsetString[i]);
		}
		// Calculate closes square number to input
		int stepsPart1 = getSteps(offsets, false);
		int stepsPart2 = getSteps(offsets, true);
	...
	private int getSteps(int[] offsets, boolean part2) {
		int[] temp = offsets.clone();
		int steps = 0;
